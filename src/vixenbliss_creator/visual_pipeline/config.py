...
class VisualPipelineSettings:
    ...
    comfyui_workflow_identity_id: str | None = None
    comfyui_workflow_identity_version: str = "v1"
    comfyui_workflow_content_id: str | None = None
    comfyui_workflow_content_version: str = "v1"
    comfyui_workflow_video_id: str | None = None
    comfyui_workflow_video_version: str = "v1"
    ...
    runpod_endpoint_image_identity: str | None = None
    runpod_endpoint_image_content: str | None = None
    runpod_endpoint_image_gen: str | None = None
    runpod_endpoint_lora_train: str | None = None
    runpod_endpoint_video_gen: str | None = None
    ...
    def from_env(cls) -> "VisualPipelineSettings":
        return cls(
            ...
            comfyui_workflow_identity_id=os.getenv("COMFYUI_WORKFLOW_IDENTITY_ID"),
            comfyui_workflow_identity_version=os.getenv("COMFYUI_WORKFLOW_IDENTITY_VERSION", "v1"),
            comfyui_workflow_content_id=os.getenv("COMFYUI_WORKFLOW_CONTENT_ID"),
            comfyui_workflow_content_version=os.getenv("COMFYUI_WORKFLOW_CONTENT_VERSION", "v1"),
            comfyui_workflow_video_id=os.getenv("COMFYUI_WORKFLOW_VIDEO_ID"),
            comfyui_workflow_video_version=os.getenv("COMFYUI_WORKFLOW_VIDEO_VERSION", "v1"),
            ...
            runpod_endpoint_image_identity=os.getenv("RUNPOD_ENDPOINT_IMAGE_IDENTITY"),
            runpod_endpoint_image_content=os.getenv("RUNPOD_ENDPOINT_IMAGE_CONTENT"),
            runpod_endpoint_image_gen=os.getenv("RUNPOD_ENDPOINT_IMAGE_GEN"),
            runpod_endpoint_lora_train=os.getenv("RUNPOD_ENDPOINT_LORA_TRAIN"),
            runpod_endpoint_video_gen=os.getenv("RUNPOD_ENDPOINT_VIDEO_GEN"),
