...
def _run_s1_llm_job(identity_id: str, state: GraphState) -> dict[str, Any]:
    ...
    payload = {
        "input": {
            ...
            "selection_policy": "score_curated_v1",
...
def _run_s1_image_job(identity_id: str, prompt_request_id: str, generation_result: dict[str, Any]) -> dict[str, Any]:
    ...
    job_input = {
        ...
        "metadata": {
            ...
            "autopromote": False,
            "samples_target": manifest.get("training_samples_target", 40),
            "render_samples_target": manifest.get("render_samples_target", 80),
            "selection_policy": manifest.get("selection_policy", "score_curated_v1"),
            "seed_bundle": seed_bundle,
        },
    }
