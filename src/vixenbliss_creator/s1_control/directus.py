...
S1_DIRECTUS_SCHEMA: dict[str, dict[str, Any]] = {
    "s1_identities": {
        ...
        "fields": [
            ...
            {"field": "identity_schema_version", "type": "string"},
            ...
            {"field": "reference_face_image_url", "type": "string"},
            {"field": "base_image_urls", "type": "json"},
            {"field": "dataset_storage_path", "type": "string"},
            {"field": "dataset_status", "type": "string"},
            {"field": "base_model_id", "type": "string"},
            {"field": "lora_model_path", "type": "string"},
            {"field": "lora_version", "type": "string"},
            {"field": "technical_sheet_json", "type": "json"},
    ...
    "content_catalog": {
        "meta": {"icon": "perm_media", "note": "Catalogo canonico de contenidos generados", "accountability": "all"},
        "fields": [
            {"field": "content_id", "type": "string"},
            {"field": "content_schema_version", "type": "string"},
            {"field": "identity_id", "type": "string"},
            {"field": "content_mode", "type": "string"},
            {"field": "video_generation_mode", "type": "string"},
            {"field": "generation_status", "type": "string"},
            {"field": "qa_status", "type": "string"},
            {"field": "job_id", "type": "string"},
            {"field": "primary_artifact_id", "type": "string"},
            {"field": "related_artifact_ids", "type": "json"},
            {"field": "base_model_id", "type": "string"},
            {"field": "model_version_used", "type": "string"},
            {"field": "provider", "type": "string"},
            {"field": "workflow_id", "type": "string"},
            {"field": "prompt", "type": "text"},
            {"field": "negative_prompt", "type": "text"},
            {"field": "seed", "type": "integer"},
            {"field": "source_content_id", "type": "string"},
            {"field": "source_artifact_id", "type": "string"},
            {"field": "duration_seconds", "type": "float"},
