    ...
    def _update_identity_snapshot(
        ...
        *,
        ...
        visual_config = {
            ...
            "workflow_family": runtime_metadata.get("workflow_family") or generation_manifest.get("workflow_family"),
            "workflow_registry_source": runtime_metadata.get("workflow_registry_source") or generation_manifest.get("workflow_registry_source"),
            "realism_profile": runtime_metadata.get("realism_profile") or generation_manifest.get("realism_profile"),
            "source_strategy": runtime_metadata.get("source_strategy") or generation_manifest.get("source_strategy"),
            "copilot_prompt_template": runtime_metadata.get("copilot_prompt_template"),
            "copilot_negative_prompt": runtime_metadata.get("copilot_negative_prompt"),
